...
print(c)
"""
data=requests.get('https://www.wnacg.org//t2.wnacg.download/data/t/0721/17/15526021386717.jpg',stream=True)
p = Image.open(data.iter_content(chunk_size=int(data.headers['content-length'])))
...
label  =tk.Label(window,width=150,height=300,bg='#000000')
